(function($) {
  ...
  $(function() {
    ...
    if ($('.v-line').length) {
      $('.v-line .container').
          append('<div class="v-line-block"><span></span></div>');
      $('.v-line .hero-started').
          append('<div class="v-line-block"><span></span></div>');
    }
    ...
    if ($('.contacts-form').length) {
      $('#cform').validate({
        ...
        submitHandler: function() {
          $.ajax({
            url: 'https://formkeep.com/f/f01f8d99811d',
            type: 'post',
            dataType: 'json',
  ...
  function setHeightFullSection() {
    ...
    $('.error-page, .menu-full-overlay, .preloader .centrize').
        css({'height': height});
  }
